...
if __name__ == '__main__':
    ...
    dataset_name = 'Gowalla-rand'           # dataset name
    model_name = 'VAECF'                      # model name (which model does this ranking file generated by)
    group_name_title = 'gowalla'           # grouping method name for distinguish different experiment results
    ...
    group_1_file = group_name_title + '_group_a_df.txt'      # advantaged group testing file name
    group_2_file = group_name_title + '_group_b_df.txt'    # disadvantaged group testing file name
    ############################################################################
